  ...
  return (
    <section id="home" className="relative min-h-[100dvh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-28 pb-20">
        {/* Frosted glass blur backdrop behind text/buttons */}
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <a
                ...
                style={{ borderRadius: '6px' }}
              >
                <span className="absolute inset-0 -z-0 translate-x-[-100%] group-hover:translate-x-0 bg-white transition-transform duration-300 ease-in-out" />
